...
class Encoder(nn.Module):
    def __init__(self, *, ch=128, ch_mult=(1,2,4,4), num_res_blocks=2,
                 ...
                 resolution=256, z_channels=4, double_z=True, use_linear_attn=False):
        super().__init__()
...
class Decoder(nn.Module):
    def __init__(self, *, ch=128, out_ch=3, ch_mult=(1,2,4,4), num_res_blocks=2,
                 attn_resolutions=(), dropout=0.0, resamp_with_conv=True, in_channels=3,
                 resolution=256, z_channels=4, give_pre_end=False, tanh_out=False
                 ):
        super().__init__()
        self.ch = ch
        self.num_resolutions = len(ch_mult)
...
class DiagonalGaussianDistribution(object):
    ...
    def mode(self):
        return self.mean, self.std, self.sample()
